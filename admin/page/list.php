...
$sth = $db->query("SELECT * FROM page ");/* LIMIT ".$start_from.",". $limit*/
$all_pages = $sth->fetchAll(PDO::FETCH_ASSOC);
  ...
  <body>
   ...
   <div class="section">
    <div class="container" id="area-contant">
    	 <div class="row">
          <div class="col-lg-12"><h1><strong>頁面管理-列表</strong></h1></div>
          </div>
        <div class="row">
          <div class="col-md-12">
            <ul class="breadcrumb">
          ...
          <table class="table">
            ...
            <?php foreach ($all_pages as $row) {?>
              <tr>
                ...
                <td><a href="edit.php?pageID=<?php echo $row['pageID'] ?>">編輯</a></td>
              </tr>
            <?php } ?>
            </tbody>
          </table>
