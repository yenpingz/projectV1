        ...
        <div class="col-md-12">
          <form class="form-horizontal" role="form" data-toggle="validator" action="edit.php" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="updatedDate" name="updatedDate" value="<?php echo date('Y-m-d'); ?>" required>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="content" name="content" data-minlength="6"><?php echo $news['content']; ?></textarea>
